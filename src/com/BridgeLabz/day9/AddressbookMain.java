...
public class AddressbookMain {
	...
	public void addDataToAddressBook() {
		...
		do {
			...
			do {
				...
				ContactBook contact = new ContactBook(firstName, lastName, address, city, state, zip, phoneNumber, emailID);
	...
	public static void searchContactByCityOrState(String city, String name) {
		...
		for (ContactBook contact : contactList) {
